...
4. Get the source code.
    ```
    go get github.com/Recras/exactonline
    ```

5. Run the PostgreSQL migration.
    ```
    go get github.com/mattes/migrate
    cd $GOPATH/src/github.com/Recras/exactonline
    migrate -url postgres://$(whoami)@$localhost:5432/exactonline?sslmode=disable -path ./migrations up
    ```
...
* **DSN:** RDBMS database path. Default: `postgres://$(whoami)@localhost:5432/exactonline?sslmode=disable`
